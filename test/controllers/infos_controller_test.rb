...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { description: @info.description, image_name: @info.image_name, image_uid: @info.image_uid, slave: @info.slave, sort: @info.sort, title: @info.title, url: @info.url }
    end
  ...
  test "should update info" do
    patch :update, id: @info, info: { description: @info.description, image_name: @info.image_name, image_uid: @info.image_uid, slave: @info.slave, sort: @info.sort, title: @info.title, url: @info.url }
    assert_redirected_to info_path(assigns(:info))
  end
